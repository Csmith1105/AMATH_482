...
mean_freq_rows = zeros(1,n);
for j=1:20
    mean_freq_rows(j) = mean(Undata(j,:));
end

% I'm not sure what this is for
mean_freq = abs(fftshift(mean_freq_rows))/20;

% Would this be the average frequency of all the points?
avg_freq = mean(mean_freq_rows);   
