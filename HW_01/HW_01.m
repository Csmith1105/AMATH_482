...
%    close all, isosurface(Kx,Ky,Kz,abs(Un_fft_filtered(:,:,:,j)),0.05)
...
for j=1:20 
   ...
   close all, isosurface(X,Y,Z,abs(Un_filtered(:,:,:,j)),0.185)
...
mean_un_filtered = mean(sum_un_filtered) % 0.1451
