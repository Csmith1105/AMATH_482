...
load test_02/test_02a_sp.mat
load test_02/test_02b_sp.mat
load test_02/test_02c_sp.mat
...
train_2a = sp_2a(:,1:size_train);
train_2b = sp_2b(:,1:size_train);
train_2c = sp_2c(:,1:size_train);


[U,S,V,thresholds,d_arr,w_arr,rank,proj_w1, proj_w2] = trainer(train_2a,train_2b,train_2c,feature);
...
test_2a = sp_2a(:,size_train+1:n);
test_2b = sp_2b(:,size_train+1:n);
test_2c = sp_2c(:,size_train+1:n);

% project the test data on the principal components & w vectors
pval_a = w_arr*U'*test_2a;
pval_b = w_arr*U'*test_2b;
pval_c = w_arr*U'*test_2c;
...
title('Test 2: training data', 'Fontsize', 16)
...
hold on
plot([thresholds(1,2);thresholds(1,2)],get(gca, 'ylim'),'r')
title('Test 2: test data', 'Fontsize', 16)
LH(1) = plot(nan, nan, 'ob');
L{1} = 'CLASS A';
LH(2) = plot(nan, nan, 'or');
L{2} = 'CLASS B';
