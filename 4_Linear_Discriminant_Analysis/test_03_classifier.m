...
load test_03/test_03a_sp.mat
load test_03/test_03b_sp.mat
load test_03/test_03c_sp.mat
...
train_3a = sp_3a(:,1:size_train);
train_3b = sp_3b(:,1:size_train);
train_3c = sp_3c(:,1:size_train);


[U,S,V,thresholds,d_arr,w_arr,rank,proj_w1, proj_w2] = trainer(train_3a,train_3b,train_3c,feature);
...
test_3a = sp_3a(:,size_train+1:n);
test_3b = sp_3b(:,size_train+1:n);
test_3c = sp_3c(:,size_train+1:n);

% project the test data on the principal components & w vectors
pval_a = w_arr*U'*test_3a;
pval_b = w_arr*U'*test_3b;
pval_c = w_arr*U'*test_3c;
...
title('Test 3: training data', 'Fontsize', 16)
...
L{3} = 'CLASS C';
legend(LH, L, 'FontSize',9, 'Location', 'northeast');
...
hold on
plot([thresholds(1,2);thresholds(1,2)],get(gca, 'ylim'),'r')
title('Test 3: test data', 'Fontsize', 16)
LH(1) = plot(nan, nan, 'ob');
L{1} = 'CLASS A';
LH(2) = plot(nan, nan, 'or');
L{2} = 'CLASS B';
...
LH(3) = plot(nan, nan, 'og');
L{3} = 'CLASS C';
legend(LH, L, 'FontSize',9, 'Location', 'southeast');
hold off
